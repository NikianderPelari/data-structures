...
* Info:  Constructs a Expression Tree object using a postfix expression
*/
...
public class ExpressionTree {
  ...
  //Method to check if token is a numerical value
  ...
  //Method to insert nodes into string builder variable
  ...
  //Method that will return integer value associated with
  ...
  //Method that will return corresponding prefix expression 
  //of expression tree
  ...
  //Method that will  return corresponding infix expression 
  //of expression tree
